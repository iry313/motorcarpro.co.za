...
<div id="comments" class="comments-area mt-5">
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title pt-5">
		    <?php
		    $storefront_ecommerce_comments_number = get_comments_number();
		    if ( 1 === $storefront_ecommerce_comments_number ) {
		        ...
		        printf(
		       		 esc_html(
				     	...
				     	_nx( 
				          	...
				          	$storefront_ecommerce_comments_number,
				          	'comments title',
				          	'storefront-ecommerce'
				       	)
				   	),
				   	esc_html (number_format_i18n( $storefront_ecommerce_comments_number ) ),
