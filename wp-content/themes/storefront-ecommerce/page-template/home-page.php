  ...
  <div class="container mt-4">
    <div class="row">
      ...
      <div class="col-lg-9 col-md-8">
        <?php if( get_theme_mod('storefront_ecommerce_slider_hide', false) != '' || get_theme_mod( 'storefront_ecommerce_display_slider',true) != ''){ ?>
                    ...
                    <div class="carousel-caption">
                      <div class="inner_carousel">
                        <div class="carousel-content">
                          <?php if( get_theme_mod('storefront_ecommerce_slider_small_title') != '' ){ ?>
                            <div class="mb-2">
                              <span class="slider-badge mb-1"><?php echo esc_html(get_theme_mod('storefront_ecommerce_slider_small_title',''));?></span>
                            </div>
                          <?php }?>
                          ...
                          <?php if( get_theme_mod('storefront_ecommerce_slider_text',true) != ''){ ?>
                            <p><?php $storefront_ecommerce_excerpt = get_the_excerpt(); echo esc_html( storefront_ecommerce_string_limit_words( $storefront_ecommerce_excerpt, esc_attr(get_theme_mod('storefront_ecommerce_slider_excerpt_number','15')))); ?></p>
                          <?php } ?>
                          <?php if (get_theme_mod( 'storefront_ecommerce_show_slider_button',true) != ''){ ?>
                            <?php if( get_theme_mod('storefront_ecommerce_slider_button_text','Find Your Home') != '' || get_theme_mod('storefront_ecommerce_slider_button_link') != ''){ ?>
                              <div class="more-btn mt-0 mt-md-3">
                                <a href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_slider_button_link')!= '') ? esc_url(get_theme_mod('storefront_ecommerce_slider_button_link')) : esc_url(get_permalink()); ?>"><?php echo esc_html( get_theme_mod('storefront_ecommerce_slider_button_text',__('Find Your Home','storefront-ecommerce'))); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('storefront_ecommerce_slider_button_text',__('Find Your Home','storefront-ecommerce'))); ?></span></a>
                              </div>
                            <?php }?>
                          <?php } ?>
                        </div>
