	    ...
	    <div class="main-wrapper py-4 px-0">
            ...
            if($storefront_ecommerce_layout_option == 'One Column'){ ?>
				<div class="content_box">
					<?php if (get_theme_mod('storefront_ecommerce_single_post_bradcrumb',false) != ''){ ?>
		    ...
		    <?php }else if($storefront_ecommerce_layout_option == 'Left Sidebar'){ ?>
		    	<div class="row">
		    		<div id="sidebar" class="<?php if( get_theme_mod( 'storefront_ecommerce_sidebar_size', 'Sidebar 1/3') == 'Sidebar 1/3') { ?>col-lg-4 col-md-4"<?php } else { ?>col-lg-3 col-md-4 <?php } ?>"><?php get_sidebar(); ?></div>
