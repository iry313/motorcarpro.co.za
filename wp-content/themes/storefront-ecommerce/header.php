...
<body <?php body_class(); ?>>
  ...
  <header role="banner" class="header-box">
    ...
    <div id="header">
      <?php if( get_theme_mod('storefront_ecommerce_show_topbar',false) != ''){ ?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 align-self-center social-icon text-lg-end text-center">
              <?php if( get_theme_mod('storefront_ecommerce_social_links') != ''){ ?>
                <?php if(get_theme_mod('storefront_ecommerce_facebook_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_facebook_url')); ?>"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_facebook_icon','fab fa-facebook-f')); ?>"></i><span class="screen-reader-text"><?php echo esc_html('Facebook', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
                <?php if(get_theme_mod('storefront_ecommerce_twitter_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_twitter_url')); ?>"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_twitter_icon','fab fa-twitter')); ?>"></i><span class="screen-reader-text"><?php echo esc_html('Twitter', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
                <?php if(get_theme_mod('storefront_ecommerce_instagram_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_instagram_url')); ?>"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_instagram_icon','fab fa-instagram')); ?>"></i><span class="screen-reader-text"><?php echo esc_html('Instagram', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
                <?php if(get_theme_mod('storefront_ecommerce_pinterest_url') != ''){ ?>
                  <a target="_blank" href="<?php echo esc_url(get_theme_mod('storefront_ecommerce_pinterest_url')); ?>"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_pinterest_icon','fab fa-pinterest-p')); ?>"></i><span class="screen-reader-text"><?php echo esc_html('Pinterest', 'storefront-ecommerce'); ?></span></a>
                <?php }?>
              <?php }?>
            </div>
      ...
      <div class="middle-header">
        <div class="container">
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="<?php if( get_theme_mod( 'storefront_ecommerce_site_logo_inline') != '') { ?>col-lg-7 col-md-7 col-7 site-logo-inline"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
                    ...
                    if ( $description || is_customize_preview() ) : ?>
                      <?php if( get_theme_mod('storefront_ecommerce_site_tagline_enable',false) != ''){ ?>
            ...
            <div class="<?php if( get_theme_mod( 'storefront_ecommerce_display_search', true) == true ) { ?>col-lg-2 col-md-6 <?php } else {?> col-lg-7 col-md-6 <?php }?> align-self-center text-md-end text-center px-md-0">
            ...
            <?php if( get_theme_mod( 'storefront_ecommerce_display_search', true) == true ) { ?>
              ...
              <div class="offset-md-3 col-lg-9 col-md-9 align-self-center">
                <div class="<?php if( get_theme_mod( 'storefront_ecommerce_sticky_header', false) != '') { ?> sticky-header<?php } else { ?>close-sticky <?php } ?>">
                  <div class="toggle-menu responsive-menu text-center">
                    <button role="tab" onclick="storefront_ecommerce_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_responsive_menu_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('storefront_ecommerce_open_menu_label')); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','storefront-ecommerce'); ?></span>
                    </button>
                  </div>
                  <div id="navbar-header" class="menu-brand primary-nav">
                    ...
                    <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="storefront_ecommerce_menu_close()"><?php echo esc_html( get_theme_mod('storefront_ecommerce_close_menu_label')); ?><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','storefront-ecommerce'); ?></span></a>
                  </div>
                </div>
              </div>
            </div>
